...
import { handleAllToggle, handleSingleToggle } from "../../components/Web_SignUp/agreementHandlers";
import { validateEmail, validatePassword, validateConfirmPassword } from "../../components/Web_SignUp/validation";
import "./style.css";

export const Web_SignUp = () => {
  const [agreement, setAgreement] = useState({ // 약관 동의 상태 정의
    all: false,
    age: false,
    service: false,
    privacy: false,
            ...
            <div className="for-mobile-frame-wrapper">
              ...
              <div className="frame-4">
                ...
                <div className="frame-4">
                  ...
                  type="single"
                  className="on-instance"
                  onClick={() => handleSingleToggle(agreement, setAgreement, "age")}
                  />
                    <div className="element">
                      <p className="text-wrapper-5">만 14세 이상 가입 동의 (필수)</p>
                    </div>
                  </div>
                  ...
                  type="single"
                  className="on-instance"
                  onClick={() => handleSingleToggle(agreement, setAgreement, "service")}
                  />
                    <div className="view-2">
                      <div className="text-wrapper-5">서비스 이용 동의 (필수)</div>
                  ...
                  type="single"
                  className="on-instance"
                  onClick={() => handleSingleToggle(agreement, setAgreement, "privacy")}
                  />
                    <div className="view-2">
