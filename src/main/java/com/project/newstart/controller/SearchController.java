...
public class SearchController {
    ...
    public ResponseEntity<Map<String, Object>> search_result(@PathVariable("keyword") String keyword) {
        ...
        List<Headline> headlines = searchService.getSearchResult(keyword);

        entitys.put("userentity", userEntity);
        entitys.put("result", headlines);
